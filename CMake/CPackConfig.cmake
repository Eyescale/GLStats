...
set(GLSTATS_PACKAGE_VERSION "" CACHE STRING "Additional build version for packages")
mark_as_advanced(GLSTATS_PACKAGE_VERSION)

if(LINUX)
  set(CPACK_PACKAGE_NAME "GLStats${VERSION_ABI}")
else()
  set(CPACK_PACKAGE_NAME "GLStats")
endif()
...
#set(CPACK_PACKAGE_DESCRIPTION_FILE ${GLStats_SOURCE_DIR}/RELNOTES.txt)
set(CPACK_PACKAGE_VERSION ${VERSION})
set(CPACK_PACKAGE_VERSION_MAJOR ${VERSION_MAJOR})
set(CPACK_PACKAGE_VERSION_MINOR ${VERSION_MINOR})
set(CPACK_PACKAGE_VERSION_PATCH ${VERSION_PATCH})
set(CPACK_RESOURCE_FILE_LICENSE ${GLStats_SOURCE_DIR}/LICENSE.txt)
set(CPACK_PACKAGE_FILE_NAME "${CPACK_PACKAGE_NAME}-${CPACK_PACKAGE_VERSION}.${CMAKE_SYSTEM_PROCESSOR}")
#set(CPACK_RESOURCE_FILE_README ${GLStats_SOURCE_DIR}/RELNOTES.txt)

if(GLSTATS_PACKAGE_VERSION)
  set(CPACK_PACKAGE_VERSION_PATCH
      ${CPACK_PACKAGE_VERSION_PATCH}-${GLSTATS_PACKAGE_VERSION})
  set(CPACK_RPM_PACKAGE_RELEASE ${GLSTATS_PACKAGE_VERSION})
endif()
...
set(CPACK_COMPONENT_LIB_DISPLAY_NAME "GLStats Library")
set(CPACK_COMPONENT_LIB_DESCRIPTION "GLStats Runtime Library")

set(CPACK_COMPONENT_DEV_DISPLAY_NAME "GLStats Development Files")
set(CPACK_COMPONENT_DEV_DESCRIPTION "Header and Library Files for GLStats Development")
